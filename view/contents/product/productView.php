                      ...
                      <div class=" row text-xs" <?php echo $displayComponent;?>>
                       ...
                       <div class="row">
                            ...
                            <i class="fas fa-pen"></i>
                             ...
                             <a title="Add to Cart" id="addToCart" href="#?productId=<?php echo $productId;?>" onclick="addToCart('<?php echo $productId;?>')" class="editProduct btn btn-info btn-circle btn-sm"  <?php echo ($viewMode=='compact'?'':'style="display:none"');?>>

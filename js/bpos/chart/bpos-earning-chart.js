...
var myLineChart = new Chart(ctx, {
  type: 'line',
  data: {
    labels: chartLabels,//["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
    datasets: [{
      label: "Earnings",
      lineTension: 0.3,
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: chartData,//[0, 10000, 5000, 15000, 10000, 20000, 15000, 25000, 20000, 30000, 25000, 40000],
    }],
  },
  options: {
			 ...
			 var url = restServicesPath+"report.php";
				...
				function(searchResult){
					$.each(searchResult,function(i,report){
						...
						addData(myLineChart,summaryMonth,report.totalSaleAmount);
					});
				},"json");
	};
